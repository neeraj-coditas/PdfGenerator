...
object PdfGenerator {
    fun createPDF(
        ...
        canvas3.drawText(primarySkill, 40F, 130F, myPaint)
        canvas3.drawText(secondarySkill, 40F, 150F, myPaint)
        canvas3.drawText(primaryDomain, 40F, 170F, myPaint)
        canvas3.drawText(secondaryDomain, 40F, 190F, myPaint)
